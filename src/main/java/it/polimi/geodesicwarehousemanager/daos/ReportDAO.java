...
public class ReportDAO {
    ...
    private final String CREATE_REPORT = "INSERT INTO reports (user, subject, body, status) VALUES (?, ?, ?, ?)";
    ...
    private ReportBean createReportBean(ResultSet resultSet) {
        ...
        try {
            ...
            report.setReportingUser(userDAO.getUserById(resultSet.getInt("user")));
